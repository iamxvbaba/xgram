...
import 'package:provider_start/core/cache/key_value_cache.dart';
import 'package:provider_start/core/models/netease/c_model.dart';
import 'package:provider_start/core/models/netease/music.dart';
import 'package:provider_start/core/models/netease/play_list_detail.dart';
import '../../music_api/music_api.dart' as api;
...
Music mapJsonToMusic(Map song,
  ...
  var album = song[albumKey] as Map;

  var artists = (song[artistKey] as List).cast<Map>().map((e) {
    return Artist(
      name: e['name'],
      id: e['id'],
    );
